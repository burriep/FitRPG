...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table fr_char (" +
                ...
                "usr_nam VARCHAR(13), " +
                "nd_pos INTEGER(2) NOT NULL, " +
                "a_str INTEGER(2) NOT NULL DEFAULT 0, " +
                "a_spd INTEGER(2) NOT NULL DEFAULT 0, " +
                "a_sta INTEGER(2) NOT NULL DEFAULT 0, " +
                "a_dex INTEGER(2) NOT NULL DEFAULT 0, " +
                "a_end INTEGER(2) NOT NULL DEFAULT 0, " +
                "loop_cnt INTEGER NOT NULL DEFAULT 0, " +
